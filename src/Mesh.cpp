...
QVector<vec3> & Mesh::vertices()
{
    return m_vertices;
}

const QVector<vec3> & Mesh::vertices() const
{
    return m_vertices;
}
...
QVector<vec3> & Mesh::normals()
{
    return m_normals;
}

const QVector<vec3> & Mesh::normals() const
{
    return m_normals;
}
...
QVector<vec2> & Mesh::texCoords()
{
    return m_texCoords;
}

const QVector<vec2> & Mesh::texCoords() const
{
    return m_texCoords;
}
